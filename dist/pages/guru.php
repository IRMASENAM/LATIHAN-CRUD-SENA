    ...
    <div class="app-wrapper"> <!--begin::Header-->
        <nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
            <div class="container-fluid"> <!--begin::Start Navbar Links-->
                ...
                <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <a href="#" class="dropdown-item"> <!--begin::Message-->
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="fs-7">can i call you mine?</p>
                            ...
                            <div class="dropdown-divider"></div> <a href="#" class="dropdown-item"> <!--begin::Message-->
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="fs-7">Let's go tomorrow nak..</p>
                                        <p class="fs-7 text-secondary"> <i class="bi bi-clock-fill me-1"></i> 4 Hours Ago
                                        </p>
                                    </div>
                                </div> <!--end::Message-->
                    ...
                    <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"> <img src="sena pict.jpg" class="user-image rounded-circle shadow" alt="User Image"> <span class="d-none d-md-inline">Irma Sena Marliyana</span> </a>
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <!--begin::User Image-->
                            <li class="user-header text-bg-warning"> <img src="sena pict.jpg" class="rounded-circle shadow" alt="User Image">
                                <p>
                                    Irma Sena Marliyana - Front End Developer
                                    <small>Member since June. 2024</small>
                                </p>
                            </li> <!--end::User Image--> <!--begin::Menu Body-->
                            <li class="user-body"> <!--begin::Row-->
                                <div class="row">
                                    <div class="col-4 text-center"> <a href="#">Followers</a> </div>
                                    <div class="col-4 text-center"> <a href="#">Experience</a> </div>
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        <li class="nav-item menu-open"> <a href="#" class="nav-link active"> <i class="nav-icon bi bi-speedometer"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item"> <a href="./index.php" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Mahasiswa</p>
                                    </a> </li>
                                <li class="nav-item"> <a href="./guru.php" class="nav-link active"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Guru</p>
                                    </a> </li>
                            </ul>
                        </li>
        ...
        <main class="app-main"> <!--begin::App Content Header-->
            <div class="app-content-header"> <!--begin::Container-->
                ...
                <div class="px-5">
                <h2>CRUD PHP dan MySQLi - WWW.MALASNGODING.COM</h2>
                   <br/>
                    <a href="tambahguru.php" class="btn btn-outline-success">+ TAMBAH GURU</a>
                   <br/>
                   <br/>
                   <table class="table table-warning table-striped">
                       ...
                       $no = 1;
                       $data = mysqli_query($koneksiguru,"select * from tbl_guru");
                       while($d = mysqli_fetch_array($data)){
                           ...
                           <tr>
                               ...
                               <td>
                                   <a class="btn btn-info" href="editguru.php?nuptk=<?php echo $d['nuptk']; ?>">EDIT</a>
                                   <a class="btn btn-danger" href="hapusguru.php?nuptk=<?php echo $d['nuptk']; ?>">HAPUS</a>
                               </td>
                           </tr>
                           <?php 
                       }
