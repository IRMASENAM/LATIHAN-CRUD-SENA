...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        <li class="nav-item menu-open"> <a href="#" class="nav-link active"> <i class="nav-icon bi bi-speedometer"></i>
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item"> <a href="./guru.php" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Guru</p>
                                    </a> </li>
                            </ul>
                        </li>
	...
	$nuptk = $_GET['nuptk'];
	$data = mysqli_query($koneksiguru,"select * from tbl_guru where nuptk='$nuptk'");
		...
		<form method="post" action="updateguru.php">
			<table>
				<tr>			
					<td>NUPTK</td>
					<td>
						<input type="number" name="nuptk" value="<?php echo $d['nuptk']; ?>">
					</td>
				</tr>
				<tr>			
					<td>Nama</td>
				...
				<tr>
					<td>Golongan</td>
					<td><input type="select" name="golongan" value="<?php echo $d['golongan']; ?>"></td>
				</tr>
				<tr>
					<td>Jenis Kelamin</td>
